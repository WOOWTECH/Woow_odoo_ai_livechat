...
class ImLivechatChannel(models.Model):
    ...
    This extension replaces the n8n webhook-based architecture with direct
    calls to OpenAI-compatible APIs (/v1/chat/completions), enabling
    AI-powered livechat without external orchestration tools.
    """
